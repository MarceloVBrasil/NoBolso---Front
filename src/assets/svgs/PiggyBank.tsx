export default function PiggyBank({ width, height, left, top, className, tamanhoTexto }: { width: string, height: string, left: string, top: string, className?: string, tamanhoTexto: string }) {
    return (
        <div className={`relative ${className}`}>
            <svg height={height} width={width} fill='yellow'
                viewBox="0 0 394.974 394.974">
                <g id="XMLID_4_">
                    <path id="XMLID_36_" fill="darkorange" d="M378.891,138.597l-21.213,21.213c9.748,9.748,9.748,25.608,0,35.356
		...
		c14.082-0.001,28.17-5.362,38.891-16.083C400.336,194.935,400.335,160.041,378.891,138.597z"/>
                    <path id="XMLID_1379_" fill="darkorange" d="M190,117.487h-51.954c-5.108-8.827-8.046-19.067-8.046-30
		...
		v60l52.814,22.635c10.455,20.436,26.804,38.102,47.186,51.371v45.994h20h30v-24.682c12.735,3.047,26.146,4.682,40,4.682V117.487z
		 M105,197.487c-8.284,0-15-6.716-15-15c0-8.284,6.716-15,15-15s15,6.716,15,15C120,190.771,113.284,197.487,105,197.487z"/>
                    <path id="XMLID_32_" fill="#FFE98F;" d="M138.046,117.487H190v-90c-28.669,0-52.627,20.112-58.57,46.993
		c-0.927,4.19-1.43,8.538-1.43,13.007C130,98.42,132.938,108.66,138.046,117.487z"/>
                    <path id="XMLID_1382_" fill="#FFDA44;" d="M190,117.487h51.954c3.438-5.94,5.882-12.521,7.116-19.525
		c0.6-3.402,0.93-6.899,0.93-10.475c0-33.138-26.863-60-60-60V117.487z"/>
                    <circle id="XMLID_1383_" fill="#FFFFFF;" cx="105" cy="182.487" r="15" />
                </g>
            </svg>
            <p className={`absolute ${top} ${left} ${tamanhoTexto} text-yellow-300`}>$</p>
        </div>
    )
}
